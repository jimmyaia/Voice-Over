...
import { ArrowLeft, ChevronRight, FileSpreadsheet, Plus, Search, Upload } from "lucide-react";
...
export default function ProjectPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  async function load() {
    ...
    setProject(projectRow as Project); setClips((clipRows as Clip[]) || []); setLoading(false);
  }
