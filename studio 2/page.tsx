      ...
      <header className="border-b border-white/10 bg-[#091713]/90 px-5 py-4 backdrop-blur md:px-8">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between">
          <div className="flex items-center gap-3">
            <a href="/" aria-label="All projects" className="grid h-10 w-10 place-items-center rounded-xl bg-[#80f0bd] text-[#07110e] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#80f0bd]">
          ...
          {projectId && (
            <a href={`/projects/${projectId}`} className="flex items-center gap-2 rounded-full border border-[#80f0bd]/20 bg-[#80f0bd]/8 px-3 py-1.5 text-xs text-[#a6f5cf] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#80f0bd]">
